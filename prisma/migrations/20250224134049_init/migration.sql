-- CreateEnum
CREATE TYPE "LLMModelSetupStatus" AS ENUM ('NOT_INITIALIZED', 'PENDING', 'IN_PROGRESS', 'PAUSE', 'RETRYING', 'FAILED', 'ROLLING_BACK', 'CANCELED', 'NEEDS_ATTENTION', 'COMPLETED');

-- CreateEnum
CREATE TYPE "ExecutionType" AS ENUM ('REST_API', 'PYTHON_FUNCTION', 'JAVASCRIPT_FUNCTION', 'CUSTOM');

-- CreateEnum
CREATE TYPE "AuthType" AS ENUM ('NONE', 'API_KEY', 'OAUTH2', 'CUSTOM');
...
-- CreateTable
CREATE TABLE "LLMModelSetupProcess" (
    "id" TEXT NOT NULL,
    "model" TEXT NOT NULL,
    "provider" TEXT,
    "status" "LLMModelSetupStatus" NOT NULL DEFAULT 'NOT_INITIALIZED',
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,
    "message" TEXT,

    CONSTRAINT "LLMModelSetupProcess_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "ScheduledTask_cron_idx" ON "ScheduledTask"("cron");
...
-- AddForeignKey
ALTER TABLE "AgentTool" ADD CONSTRAINT "AgentTool_toolConfigId_fkey" FOREIGN KEY ("toolConfigId") REFERENCES "ToolConfig"("id") ON DELETE CASCADE ON UPDATE CASCADE;
